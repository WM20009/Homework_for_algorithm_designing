...
说明：45个随机点均匀分布在单位正方形内


#### 截图2：第一次分割
![1st divide](image-2.png)

*说明：红色虚线x=0.503将点集分为左右两部分*

---

#### 截图3：带区构造
![带区构造](screenshot_3_strip.png)

*说明：黄色矩形区域为宽度2δ的带区，包含5个点*

---

#### 截图4：带区扫描
![带区扫描](screenshot_4_strip_scan.png)

*说明：按y坐标扫描带区内的点，每个点只检查常数个邻居*

---

#### 截图5：最终结果
![最终结果](screenshot_5_final.png)

*说明：红色粗线连接最近点对，虚线圆表示距离范围*
...
```python
# 暴力法结果
min_distance_brute = 0.072347
pair_brute = (点23, 点35)

# 分治法结果
min_distance_divide = 0.072347
pair_divide = (点23, 点35)
...
最小距离: 0.072347
最近点对:
  点1: (0.486123, 0.523456)
  点2: (0.521234, 0.578901)

正在生成动画...
动画已保存到: closest_pair_animation.mp4
